...
if __name__ == '__main__':
    ...
    assert agg.get_targets() == {('triangle', 'red', 'Q', 'black'): [(4, 6)],
                                 ('square', 'green', 'X', 'white'): [(4, 6)]}, \
    ...
    assert agg.get_targets() == {('triangle', 'red', 'Q', 'black'): [(4, 8)],
                                 ('square', 'green', 'X', 'white'): [(4, 6)]}, \
    ...
    assert agg.get_targets() == {('triangle', 'red', 'Q', 'black'): [(4, 8), (4, 30)],
                                 ('square', 'green', 'X', 'white'): [(4, 6)]}, \
