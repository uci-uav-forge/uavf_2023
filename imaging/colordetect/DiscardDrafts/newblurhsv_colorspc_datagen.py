...
dic_lowerbounds = {"red": [np.array([0, 138, 163],np.uint8), np.array([171, 138, 163],np.uint8)], "orange": np.array([12, 138, 163],np.uint8), \
                   ...
                   "black": np.array([0, 0, 0],np.uint8), "white": np.array([0, 0, 214],np.uint8), "brown":np.array([9,104,80],np.uint8)
                   } 

dic_upperbounds = {"red": [np.array([11, 255, 255],np.uint8), np.array([179, 255, 255],np.uint8)], "orange": np.array([21, 255, 255],np.uint8), \
                   ...
                   "black": np.array([179, 255, 39],np.uint8), "white": np.array([179, 26, 255],np.uint8), "brown":np.array([22,255,128])}
