...
class Pipeline:
    ...
    def __init__(self):
        ...
        model_file=f"shape_detection/trained_models/efficientnet_lite0_pytorch_25epoch.pt"
    ...
    def loop(self):
        ...
        print(list(zip(letter_labels,itertools.chain(*shape_labels))))
