...
from shape_detection.shape_inference import suppress_nonmax_bboxes
...
class Pipeline:
    ...
    def __init__(self):
        ...
        self.shape_model = ort.InferenceSession("yolo/trained_models/v8n.onnx", providers = ['CUDAExecutionProvider']) # For GPU: CUDAExecutionProvider
    ...
    def loop(self):
        ...
        img = cv.imread("gopro-image-5k.png") # (2988, 5312, 3)
        h, w = img.shape[:2]
